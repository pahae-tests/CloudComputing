...
const Dashboard = () => {
  ...
  return (
    <div className={`min-h-screen p-8 ${darkMode ? 'bg-gray-900 text-gray-100' : 'bg-white text-gray-800'}`}>
      ...
      {/* Section de recommandation pour l'application mobile */}
<div className={`rounded-xl p-6 border mt-8 ${darkMode ? 'border-gray-700 bg-gray-800' : 'border-gray-200 bg-white'}`}>
  <div className="flex flex-col md:flex-row items-center justify-between">
    <div className="flex-1 mb-4 md:mb-0 md:mr-6">
      <h3 className="text-xl font-semibold mb-2">Téléchargez notre application mobile</h3>
